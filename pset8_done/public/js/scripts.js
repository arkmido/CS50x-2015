...
function addMarker(place)
{
    ...
    // we have map, markers[],  info = InfoWindow
    var _lat = parseFloat(place.latitude);
    var _lng = parseFloat(place.longitude);
    ...
    var marker = new MarkerWithLabel({
        ...
        labelClass: "label",
        title: 'News',
        icon: 'img/conversation-map-icon.png',
        ...
        $.getJSON("articles.php", {geo: place.postal_code})
            .done(function(data, textStatus,jqXHR){
                if(data.length == 0)
                    ...
                    var content = '<ul>';
                    for (var d in data){
                        content += '<li><a href="'+ data[d].link +'">'+data[d].title +'</li>';
                    }
                    content += '</ul>';
                }
